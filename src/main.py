...
def run():
    ...
    for i in range(steps):
        ...
        # (4) ASTROCYTE Ca2+ + IP3
        Ca_astro = astro_model.compute_derivatives(dt_sec, current_glu_syn)

        # (5) GLIOTRANSMITTER FEEDBACK
        current_glu_extra = glia_trans_model.step(dt_sec, Ca_astro)
        ...
        rec_Glu_Syn[i] = current_glu_syn * 1e3
        rec_Ca_Astro[i] = Ca_astro * 1e6
        rec_IP3_Astro[i] = astro_model.p_a * 1e6
        rec_Glu_Extra[i] = current_glu_extra * 1e3
    ...
    ax1[0].plot(time_array, rec_V_pre)
    ...
    ax1[2].plot(time_array, rec_Ca_ER)
    ax1[2].set_ylabel("Ca_ER (uM)")

    ax1[3].plot(time_array, rec_IP3_Pre)
    ...
    ax2[0].plot(time_array, rec_Glu_Syn)
    ax2[0].set_ylabel("Glu_syn (mM)")

    ax2[1].plot(time_array, rec_IP3_Astro)
    ax2[1].set_ylabel("IP3_astro (uM)")

    ax2[2].plot(time_array, rec_Ca_Astro)
    ax2[2].set_ylabel("Ca_astro (uM)")

    ax2[3].plot(time_array, rec_Glu_Extra)
    ax2[3].set_ylabel("Glu_extra (mM)")
    ...
    ax3[0].plot(time_array, rec_V_post)
    ax3[0].set_ylabel("V_post (mV)")

    ax3[1].plot(time_array, rec_Ca_Post)
    ax3[1].set_ylabel("Ca_post (uM)")

    ax3[2].plot(time_array, rec_CaMKII_P)
    ax3[2].set_ylabel("CaMKII-P (uM)")

    ax3[3].plot(time_array, rec_Alpha_Mod)
    ax3[3].set_ylabel("alpha (mod)")
